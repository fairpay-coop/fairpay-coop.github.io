...
checkExternalUrl = function(url) {
    ...
    //var previewLinkPattern = new RegExp('^(http[s]?://)([a-z0-9-.]+)(?:\\:\\d+)?(/preview/[0-9]+/[a-z0-9\-]+((.html)|(/))(\\?mobile=true)?)$');
    var previewLinkPattern = new RegExp('^(http[s]?://)([a-z0-9-.]+)(?:\\:\\d+)?/(preview|internalPreview)/([0-9]+/[a-z0-9\-]+((.html)|(/))(\\?mobile=true)?)$');
